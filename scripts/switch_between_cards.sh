...
101)
 ...
 then
  notify-send -t 3000 --icon="/home/$USER/.local/share/icons/hardware_down.png" "switching to $name_integrated"
 ...
 then
  notify-send -t 3000 --icon="/home/$USER/.local/share/icons/hardware_down.png" "already switched to $name_integrated"  
 fi
;;
102)
 if [ "$integrated" == ":+:Pwr:" ] && [ "$discrete" == ": :Pwr:" ]
 then
  notify-send -t 3000 --icon="/home/$USER/.local/share/icons/hardware_up.png" "switching to $name_discrete"
 ...
 then
  notify-send -t 3000 --icon="/home/$USER/.local/share/icons/hardware_up.png" "already switched to $name_discrete"  
 fi
;;
esac
